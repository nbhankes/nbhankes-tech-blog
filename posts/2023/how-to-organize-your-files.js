...
I'd been drafting a book and relying on my [reMarkable tablet](https://remarkable.com/store/remarkable-2) to document much of my ideation. It's a nice tool, but the file storage model felt limited. Originally, I'd attempted to follow the [Zettelkasten](https://en.wikipedia.org/wiki/Zettelkasten), or slip box, method. My experiment involved organizing like files using naming conventions because I wanted all files in the same folder depth. This way I could scroll through a sinlge folder and take it in holistically (hey, I'm an artist, okay). But the naming conventions fell apart as the project ballooned. I ran into issues where the native file sorting methods moved filed throughout the folder. With hindsight, I can tackle the problem with a new naming convention. But at the time, it planted the idea that I needed to step up my file management game.
